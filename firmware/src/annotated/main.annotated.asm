...
;------------------------------------------------------------------------------
; External Interrupt 1 (ADC end-of-conversion on P3.3) axis servo ISR, reached
; via the 0x0013 vector (LJMP 0x00C0). One interrupt services the axis selected
; by the rotating mask at 0x22, samples/advances the ADC round-robin, computes a
; bounded motor command, and writes it to the 8255 Port A/C shadows.
;
; The full annotated listing for this handler now lives in its own file:
;     firmware/src/annotated/ext1_axis_servo.annotated.asm
; (extracted for readability; behavior/provenance unchanged).
;==============================================================================
